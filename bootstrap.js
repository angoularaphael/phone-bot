...
if (fs.existsSync(ROOT_ENV_PATH)) {
    ...
    const ENV_KEYS = [
        ...
        'GROQ_API_KEY', 'GROQ_API_KEY_FALLBACK', 'GROQ_API_KEY_2', 'GROQ_API_KEY_3', 'GROQ_MODEL',
        ...
        'GEMINI_API_KEY_8', 'GEMINI_API_KEY_9', 'GEMINI_API_KEY_10', 'GEMINI_API_KEY_11',
        'GEMINI_MODEL', 'AI_PROVIDER', 'MISTRAL_API_KEY',
        'USE_AI_REPLY',
